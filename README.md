...
- #50. Добавить пакет аудита на основе паттерна Наблюдатель
- #51. Добавить Observer, который пишет аудит в указанный файл
- #52. Добавить Observer, который отправляет аудит методом POST на указанный URL
