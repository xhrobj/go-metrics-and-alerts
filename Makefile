...
# тестовые RSA-ключи
SERVER_PRIVATE_KEY=internal/encryption/testdata/private.pem
AGENT_PUBLIC_KEY=internal/encryption/testdata/public.pem
...
run-server-crypto: build-server
	./$(SERVER) \
